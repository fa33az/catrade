...
2. **Jalankan Aplikasi Secara Concurrently**:
   Aplikasi ini dikonfigurasi untuk menjalankan frontend dan backend secara bersamaan menggunakan satu perintah di root folder:
   ```bash
   npm run dev
   ```
   - **Frontend**: Akses di [http://localhost:5173/](http://localhost:5173/)
   - **Backend**: Berjalan di [http://localhost:5000/api](http://localhost:5000/api)
